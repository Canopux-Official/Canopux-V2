export const siteConfig = {
  ...
  social: {
    ...
    twitterHandle: "@canopux",
    github: "https://github.com/Canopux-Official",
  },
  expertise: [
    { area: "Full Stack", count: "5 Devs" },
    { area: "AI / ML", count: "3 Engineers" },
    { area: "App Developers", count: "2 Devs" },
    { area: "Cloud / DevOps", count: "3 Engineers" },
